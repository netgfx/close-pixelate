 ...
 * 
 * - Addition with video support by Michael Dobekidis http://www.netgfx.com
 * 
...
ClosePixelation.prototype.render = function( options ) {
  ...
  if(options[0].video == true){
  	// set size
    this.video = this.img;
    w = this.width = this.canvas.width = options[0].videoW;
    h = this.height = this.canvas.height = options[0].videoH;
